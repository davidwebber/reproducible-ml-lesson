_pixi() {
    ...
    case "${cmd}" in
        pixi)
            opts="-h -v -q -V --help --verbose --quiet --color --no-progress --version add a auth build clean completion config exec x global g info init import install i list ls lock reinstall remove rm run r search self-update shell s shell-hook task tree t update upgrade upload workspace help"
            ...
            ;;
        pixi__add)
            opts="-p -f -g -s -h -v -q --manifest-path --host --build --pypi --platform --feature --git --branch --tag --rev --subdir --no-install --revalidate --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --editable --help --verbose --quiet --color --no-progress <SPEC>..."
        ...
        pixi__auth__logout)
            ...
            ;;
        pixi__build)
            opts="-t -o -b -c -h -v -q --manifest-path --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --target-platform --output-dir --build-dir --clean --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__clean)
            opts="-e -h -v -q --manifest-path --environment --activation-cache --build --help --verbose --quiet --color --no-progress cache help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__clean__cache)
            opts="-y -h -v -q --pypi --conda --mapping --exec --repodata --build-backends --build --yes --manifest-path --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__config__unset)
            ...
            ;;
        pixi__exec)
            opts="-s -w -c -p -h -v -q --spec --with --channel --platform --force-reinstall --list --no-modify-ps1 --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress [COMMAND]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global)
            ...
            ;;
        pixi__global__add)
            opts="-g -s -e -h -v -q --git --subdir --path --environment --expose --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress <PACKAGE>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global__expose__add)
            opts="-e -h -v -q --environment --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress [MAPPING]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global__expose__remove)
            opts="-h -v -q --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress [EXPOSED_NAME]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global__install)
            opts="-g -s -c -p -e -h -v -q --git --subdir --path --channel --platform --environment --expose --with --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --force-reinstall --no-shortcuts --help --verbose --quiet --color --no-progress <PACKAGE>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__global__list)
            opts="-e -h -v -q --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --environment --sort-by --help --verbose --quiet --color --no-progress [REGEX]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global__remove)
            opts="-e -h -v -q --environment --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress <PACKAGE>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global__shortcut__remove)
            opts="-h -v -q --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress [SHORTCUT]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__global__sync)
            opts="-h -v -q --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global__uninstall)
            opts="-h -v -q --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress <ENVIRONMENT>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global__update)
            opts="-h -v -q --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress [ENVIRONMENTS]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global__upgrade__all)
            opts="-c -h -v -q --channel --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --platform --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__help)
            opts="add auth build clean completion config exec global info init import install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__help__workspace__version__set)
            ...
            ;;
        pixi__import)
            opts="-p -e -f -h -v -q --manifest-path --format --platform --environment --feature --no-install --revalidate --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress <FILE>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__init)
            ...
            ;;
        pixi__install)
            opts="-e -a -h -v -q --manifest-path --frozen --locked --environment --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --all --skip --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__lock)
            ...
            ;;
        pixi__reinstall)
            opts="-e -a -h -v -q --manifest-path --frozen --locked --environment --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --all --help --verbose --quiet --color --no-progress [PACKAGE]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__remove)
            ...
            ;;
        pixi__run)
            opts="-e -n -h -v -q --manifest-path --no-install --revalidate --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --force-activate --no-completions --environment --clean-env --skip-deps --dry-run --help --verbose --quiet --color --no-progress [TASK]..."
            if [[ ${cur} == -* ]] ; then
               COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
               return 0
        ...
        pixi__self__update)
            ...
            ;;
        pixi__shell)
            opts="-e -h -v -q --manifest-path --no-install --revalidate --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --environment --change-ps1 --force-activate --no-completions --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__shell__hook)
            opts="-s -e -h -v -q --shell --manifest-path --no-install --revalidate --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --force-activate --no-completions --environment --json --change-ps1 --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__tree)
            ...
            ;;
        pixi__update)
            opts="-n -e -p -h -v -q --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --manifest-path --no-install --dry-run --environment --platform --json --help --verbose --quiet --color --no-progress [PACKAGES]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__upgrade)
            opts="-f -n -h -v -q --manifest-path --no-install --revalidate --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --feature --exclude --json --dry-run --help --verbose --quiet --color --no-progress [PACKAGES]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__workspace__channel__add)
            opts="-f -h -v -q --manifest-path --priority --prepend --no-install --revalidate --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --feature --help --verbose --quiet --color --no-progress <CHANNEL>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__workspace__export__conda__explicit__spec)
            opts="-e -p -h -v -q --manifest-path --environment --platform --ignore-pypi-errors --ignore-source-errors --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress <OUTPUT_DIR>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
